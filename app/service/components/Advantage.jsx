...
function Advantage() {
  ...
  return (
    <section className="cusContaner m-auto my-3">
      <div
        className="bg-auxiliaryColorGray w-full xl:w-[40%]  m-auto gap-5 flex justify-center 
      ...
      <div className="my-10  grid grid-cols-1 xl:grid-cols-2 gap-5 justify-items-center">
        {activeTab == tabs[0]
