...
export const Prodect = [
  { key: 1, name: "للباحثين عن عمل", href: "#" },
  { key: 2, name: "للشركات", href: "#" },
  { key: 3, name: "تحليل السيرة الذاتية", href: "#" },
  { key: 4, name: "اختبارات المهارات", href: "#" },
];

export const Company = [
  { key: 1, name: "من نحن", href: "#" },
  { key: 2, name: "المدونة", href: "#" },
  { key: 3, name: "اتصل بنا", href: "#" },
  { key: 4, name: "الوظائف", href: "#" },
];

export const Low = [
  { key: 1, name: "الشروط والأحكام", href: "#" },
  { key: 2, name: "سياسة الخصوصية", href: "#" },
  { key: 3, name: "ملفات الارتباط", href: "#" },
];
